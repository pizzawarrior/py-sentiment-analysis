...
'''
    ...
    In essence, if you're working in a Jupyter Notebook environment, the
    %matplotlib inline command is the preferred way to handle Matplotlib plots.
    If you are using a standard Python script, you should use matplotlib.pyplot.ion()
    and matplotlib.pyplot.ioff() to control how plots are displayed.
'''
